...
const Footer = () => {
    ...
    return (
        <footer className='w-full h-full py-10 pb-20 md:pb-10 bg-[#f1f5f5] z-10 relative font-poppins overflow-hidden'>
            ...
            <div className="bg-white w-full md:h-14 absolute bottom-0 left-0 flex items-center md:px-20 justify-between md:flex-row flex-col py-6 h-auto gap-y-3">
                <p className="text-xs font-ginger font-light text-center md:text-left" ref={ftRef}>
                    COPYRIGHT WEB AI. 2023. ALL RIGHT RESERVED
                </p>
