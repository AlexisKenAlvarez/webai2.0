...
const Partners = () => {
    ...
    return (
        <section className="w-full min-h-screen h-auto bg-mywhite z-10 relative overflow-hidden py-10 px-8">
            ...
            <AnimateText>
                <h1 className='font-bold md:text-7xl sm:text-5xl text-3xl max-w-[45rem] text-center mx-auto mt-[12rem] relative z-10'>WE WORK WITH THE BEST PARTNERS</h1>
            ...
            <motion.img animate={{ rotate: 360 }} transition={{ duration: 14, repeat: Infinity, ease: "linear" }} src="/partners/globe.webp" alt="Globe" className="absolute top-32 -left-10 right-0 mx-auto select-none" />
            ...
            <div className="w-fit mx-auto flex mt-32 gap-x-10 items-center lg:flex-row flex-col text-center lg:text-left gap-y-10 pb-10">
                ...
                <div className="">
                    <div className="overflow-hidden">
                        <motion.h1 initial={{ opacity: 0 }} whileInView={{ y: [30, 0], opacity: 1 }} transition={{ duration: 0.7, ease: [.17, .60, .50, 1] }} className='font-bold md:text-6xl text-3xl max-w-[30rem]'>BITMART PARTNERSHIP</motion.h1>
                    </div>

                    <div className="overflow-hidden">
                        <motion.p initial={{ opacity: 0 }} whileInView={{ y: [30, 0], opacity: 1 }} transition={{ duration: 0.7, ease: [.17, .60, .50, 1] }} className='max-w-[30rem] mt-3 opacity-80'>BitMart is a global cryptocurrency exchange that allows users in 180+ countries to buy and sell over 1,000 digital currencies and tokens.</motion.p>
                    </div>
                ...
                <div className="h-fit rounded-xl  md:w-[25rem] w-[20rem]">
                    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, y: [40, 0] }} transition={{ duration: 0.7, ease: [.17, .60, .50, 1], delay: 0.5 }} className="relative z-10">
                        <Tweet tweetId='1630223208291901442' className="w-full z-10 relative" />
                    </motion.div>
