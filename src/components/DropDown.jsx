...
const DropDown = (props) => {
    ...
    return (
        <div className="select-none">
            <div className='w-full bg-[#D7D7D7] hover:bg-[#dfdfdf] transition-all ease-in-out duration-300 h-20 cursor-pointer justify-between items-center flex p-7 shadow-md group' onClick={handleToggle}>
                ...
                <div className="w-7 h-7 opacity-70 relative transition-all ease-in-out duration-300" style={toggle ? { transform: "rotate(270deg)" } : {}}>
